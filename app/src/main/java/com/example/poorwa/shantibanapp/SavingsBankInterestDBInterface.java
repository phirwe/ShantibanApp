...
import com.example.poorwa.shantibanapp.SavingsBankInterestDBHelper.*;

/**
 * Created by poorwa on 29/1/16.
 */
public class SavingsBankInterestDBInterface extends SQLiteOpenHelper {
    ...
    public SavingsBankInterestDBInterface(Context context) {
    ...
    public void insert(SavingsBankInterest income) {
    ...
    public SavingsBankInterest getInfo(String accountNumber) {
        SQLiteDatabase SQ = this.getReadableDatabase();
        SavingsBankInterest income = new SavingsBankInterest();
        Cursor c;
    ...
    public void update(SavingsBankInterest income) {
        SQLiteDatabase SQ = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
